...
{
    public partial class PrintRequisition : ContentPage
    {
        ...
        public PrintRequisition(string EmployeeId, int RequisitionId, int RequisitionTypeId, string Departmentid, string EventId, int ReqCount)
        {
            InitializeComponent();
        ...
        protected async override void OnAppearing()
        {
            ...
            objReqTotal = await App.TodoManager.GetPrintRequisition(objReqTotal);
            ...
            BindGeneralDetails(objReqTotal.GetPrintReqDetail);
            //listgenDetails.ItemsSource = objReqTotal.GetPrintReqDetail;
        ...
        void BindGeneralDetails(List<GetPrintReqDetail> lstGeneralDetails)
        {
            int indx = -1;
