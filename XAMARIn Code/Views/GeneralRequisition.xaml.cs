...
{
    public partial class GeneralRequisition : ContentPage
    {
        ...
        public GeneralRequisition(string EmployeeId, int RequisitionId, int RequisitionTypeId, string Departmentid, string EventId, int ReqCount)
        {
            InitializeComponent();
            ...
            if (RequisitionTypeId == 3)
                Title = "Conference/Exhibition Requisition";
            else if (RequisitionTypeId == 6)
                Title = "IT Requisition";
            else if (RequisitionTypeId == 10)
                Title = "Miscellaneous Requisition";
            else if (RequisitionTypeId == 7)
                Title = "Audio - Visual Requisition";
            else if (RequisitionTypeId == 8)
                Title = "BackDrop/Banner Requisition";
            else if (RequisitionTypeId == 9)
        ...
        protected async override void OnAppearing()
        {
            ...
            objReqTotal = await App.TodoManager.GetGeneralRequisition(objReqTotal);
            ...
            //listgenDetails.ItemsSource = objReqTotal.TravelReqDetail;
